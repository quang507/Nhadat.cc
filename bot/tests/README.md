...
|---|---|---|---|
| `e2e/run.mjs` | 193 | `bun run e2e` (qua `chay.sh`) | Luồng `chat-reply` thật: cổng vào (CỔNG-1…5), bảo mật (SEC-\*), tranh chấp ghi đồng thời (ĐUA-1…4), chống trùng lượt vào (TRÙNG-1…10) |
