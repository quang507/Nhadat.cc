...
export class FakeDB {
  ...
  missingFacts() {
    ...
    const REQ = {
      toa_nha: [CB("vi_tri", 2), CB("dien_tich_dat", 3), CB("ket_cau", 4), CB("so_phong", 5), CB("thang_may", 6), CB("do_rong_hem", 7), CB("ty_le_lap_day", 8), CB("doanh_thu", 9), CB("gia", 12), CB("pccc", 15), CB("phap_ly", 16), CB("phuong", 17), CB("gap", 18), CB("hinh_anh", 19), SD("tang_phu", 30)],
      ...
      nha_pho: [CB("vi_tri", 2), CB("dien_tich_dat", 3), CB("ket_cau", 4), CB("so_phong_ngu", 5), CB("noi_that", 6, "cho_thue"), CB("do_rong_hem", 7), CB("gia", 12), CB("tien_coc", 13, "cho_thue"), CB("thoi_han_thue", 14, "cho_thue"), CB("truot_gia", 15, "cho_thue"), CB("phap_ly", 16), CB("phuong", 17), CB("gap", 18), CB("hinh_anh", 19), ...SAU_NHA, SD("tang_phu", 30), SD("tiem_nang", 39)],
      nha_cap4: [CB("vi_tri", 2), CB("dien_tich_dat", 3), CB("hien_trang", 4), CB("so_phong_ngu", 5), CB("noi_that", 6, "cho_thue"), CB("do_rong_hem", 7), CB("gia", 12), CB("tien_coc", 13, "cho_thue"), CB("thoi_han_thue", 14, "cho_thue"), CB("phap_ly", 16), CB("phuong", 17), CB("gap", 18), CB("hinh_anh", 19), SD("tang_phu", 30), SD("tiem_nang", 39)],
      ...
      biet_thu: [CB("vi_tri", 2), CB("dien_tich_dat", 3), CB("ket_cau", 4), CB("so_phong_ngu", 5), CB("san_vuon", 6), CB("noi_that", 7, "cho_thue"), CB("do_rong_hem", 8), CB("khu_compound", 9), CB("gia", 12), CB("tien_coc", 13, "cho_thue"), CB("thoi_han_thue", 14, "cho_thue"), CB("phap_ly", 16), CB("phuong", 17), CB("gap", 18), CB("hinh_anh", 19), SD("tang_phu", 30)],
