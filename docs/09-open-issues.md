...
| OPEN-58 | 🟡 **Tra phường theo SỐ NHÀ** (chủ dự án 25/09/2026: "google map api muốn dùng cần trả bao nhiêu, hiện tại người ta đưa số nhà và tên đường và quận rồi nhưng mà lại cố hỏi là phường nào"). FR-223 (n) tra bảng `duong` (OSM, miễn phí) theo quận: đủ khi đường nằm gọn một phường, còn đường qua nhiều phường thì vẫn phải hỏi chọn, và bảng mới có đường của 94/168 phường TP.HCM. Nominatim (OSM, miễn phí) đang trả "Access denied". **Phương án**: (a) nạp nốt bảng `duong` cho 74 phường còn lại (`scripts/nap-duong.mjs`, cần khoá service_role trên máy chủ dự án) — miễn phí, vẫn không biết số nhà; (b) Google Geocoding API theo số nhà — theo trang giá Google (cập nhật 17/09/2026): 10.000 lượt miễn phí mỗi tháng, sau đó 5 USD / 1.000 lượt; cần tài khoản Google Cloud có thẻ; CHƯA kiểm Google trả phường MỚI (sau sáp nhập 07/2025) hay phường cũ — phải thử trước khi dùng. **Khuyến nghị BA:** (a) ngay, (b) thử 20–50 địa chỉ thật trước khi quyết. **Chờ chủ dự án chốt.** | FR-223 n, FR-209, FR-212 |
