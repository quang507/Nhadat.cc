...
| FR-159 | UF-04, UF-05, UF-10 | WF-05 | *[dựng 01/09/2026: migration `20260901d_mo_ho_so_nguoi_ban.sql` (RPC idempotent, chỉ service_role); `chat-reply` nửa 1/2 `tuNhanCoBDS` + `sellerMoi` trước nhánh bán, nửa 2/2 câu hỏi vai + cờ `preferences.hoi_vai` sau khi ghi tin khách; `wantsSell` dời lên trước nhánh bán. Kiểm TS-VAI-01…05. SRS-3.4, SRS-3.12]* | — |
