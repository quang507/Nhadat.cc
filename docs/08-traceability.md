...
| FR-177 | UF-04 | — | ⏳ chưa code (07/09): migration `required_facts.priority` (giá lên thứ 2, bỏ hướng/quy hoạch/năm xây khỏi vòng đầu), hàm điểm tin 7 tiêu chí (tiền định), `SELLER_SCRIPT_RULES` khích lệ + bản nháp tin, `listings_autopublish` theo điểm ≥ 70; e2e tái hiện 20 câu Gemini lượt 3. Nguồn gốc: `Kịch bản huấn luyện môi giới (Gemini 07-09-2026).md` | — |
| FR-97 | | — | — | — |
