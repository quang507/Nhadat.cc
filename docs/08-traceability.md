...
| FR-205 | UF-04, UF-05, UF-10 | WF-05 | `_shared/extraction/phan-vai-loc.ts` (`coMuiBDS`, `nenHoiModelVai`, `donVai`) + `_shared/ai/phan-vai.ts` (`phanVaiBangModel`); `chat-reply`: `wantsSellLuat` → lượt model khi luật không kết luận → `wantsSell`/`hoiMua`. Kiểm: TS-VAI-01, TS-VAI-02 | — |
