...
| TS-AIBOC-09 | FR-208 (g) bắn lại trên production sau deploy: 4 câu rao model từng đọc sai ở TS-AIBOC-07 (đất vườn Củ Chi 2000m2; villa Thảo Điền; toà CHDV thu nhập 180 triệu/tháng; phòng trọ không dấu 25m2) + 1 câu nối 'ngang 5 dài 20 nha, hẻm xe hơi, để em coi lại sổ rồi báo' | `dai` không còn = 2000; không `du_an` Thảo Điền; `thu_nhap_thue` đạt → `rent_income_vnd`; `dien_tich` đạt (số trần); không hiện trạng 'xe hơi', không kiến thức lời hứa; sổ đo `bo` giảm so với lượt trước | ⏳ bắn sau deploy |
