...
| TS-AIBOC-07 | FR-208 (f) bắn thật 15 tin trên production với `boc_tach_ai = chinh` (deploy sau PR chế độ `chinh`), Zalo giả `mau-v-01…15`: 10 loại BĐS + các câu từng hỏng ở TS-VAN-10/11 ("bớt 50 triệu", "hợp đồng phân phối", "quý 2 năm sau", "phường 7 quận 6 đó em…", tin emoji, chủ đầu tư, không dấu, giá/m² × ngang×dài, thế chấp) | mỗi tin: cột lõi đúng câu rao, không fact rác từ luật tìm-chuỗi, câu hỏi đầu hợp lý; đếm lỗi so với 7 lỗi TS-VAN-11 | ⏳ bắn sau deploy — ghi kết quả vào đây |
