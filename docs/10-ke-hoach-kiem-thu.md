...
| TS-GROQ-06 | FR-194 c: bắn lại tin rao thử sau deploy, đọc log edge function | KHÔNG còn dòng "Groq chan tran/hong" cho lượt bóc tách; tin rao lưu đúng | ⏳ |
