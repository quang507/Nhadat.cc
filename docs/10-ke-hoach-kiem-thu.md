...
| TS-DUAN-03 | FR-196: hỏi bot 5 câu tầng dự án trên production (số căn, tiện ích, phí quản lý, quận + năm bàn giao, loại căn + diện tích, giá đất nền) rồi ĐỐI CHIẾU từng con số với `projects` | mỗi con số nói ra phải có trong kho; không có thì bot nói "để em xác nhận lại" | ⏳ đo lần 1 (07:42 UTC 10/09) HỎNG: The Beverly kho ghi studio 32,5m²/2PN 78,7m² mà bot nói 1PN hơn 30m²/2PN 55-70m² → thêm luật số + đào sâu; đo lại sau khi đào xong |
