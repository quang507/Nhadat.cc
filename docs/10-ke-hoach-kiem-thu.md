...
|---|---|---|---|---|
| `bot/tests/e2e/run.mjs` | 244 | `bun run e2e` (`chay.sh`) | TS-E2E, TS-TOIUU; nhãn `CỔNG-1…5`, `SEC-*`, `ĐUA-1…4`, `TRÙNG-1…10`, `N1…N24` (09–10/09) | Luồng `chat-reply` thật; cổng vào; tranh chấp ghi đồng thời; chống trùng lượt vào |
...
| `bot/tests/fr177-hoi-nhu-moi-gioi-gioi.mjs` | 196 | `bun run test:bot` | **TS-KYGUI** phần nhận fact / chọn câu kế / gật / đủ rồi / gấp | `nhanDienFact`, `chonCauKe`, `laDongY`, `laDuRoi`, `laGap` (FR-177/178) — tiền định, không tốn model |
