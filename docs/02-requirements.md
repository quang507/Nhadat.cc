...
| FR-130 | **Khai thác nhu cầu người mua nhỏ giọt, giống người**: bot duy trì hồ sơ nhu cầu tích luỹ trong `buyers.preferences` (mua/thuê, khu vực, khoảng giá, mục đích ở/kinh doanh, loại hình, số PN, hẻm/mặt tiền, thời điểm cần) — bóc tách tự động sau mỗi tin của B, **không hỏi lại điều đã biết**, gặp lại nhắc đúng nhu cầu cũ; mỗi lượt hỏi ĐÚNG MỘT tiêu chí còn thiếu theo thứ tự UF-04 (khu vực + khoảng giá trước, chưa đủ thì chưa gợi ý căn), trả lời trước — hỏi sau; bot đã hỏi 2 lượt liên tiếp thì lượt kế đưa giá trị (gợi ý căn khớp hồ sơ) thay vì hỏi tiếp; trả lời được tách tối đa 2 bong bóng ngắn, gửi lần lượt như người nhắn tay | M | quyết định chủ dự án 25/08/2026 "bên mua cũng hỏi từ từ… giống con người nhất có thể"; UF-04, chưng cất `chats w B.docx` |
| FR-131 | **Gộp tin nhắn gõ vụn**: khách hay gõ 3–4 tin liên tiếp ("tìm nhà" / "quận 10" / "tầm 2 tỷ") — bot đợi ~5 giây; trong lúc đợi có tin mới hơn của cùng khách thì nhường lượt (không trả lời), chỉ lượt của tin cuối chùm trả lời trên toàn bộ ngữ cảnh gộp → MỘT câu trả lời duy nhất thay vì 3 câu chồng nhau. Kèm chống đua tạo trùng buyer/conversation khi tin đến đồng thời (advisory lock theo `zalo_user_id`) | M | quyết định chủ dự án 25/08/2026; bổ trợ FR-130 |
...
| FR-133 | **Nhắc hẹn + hỏi thăm khi im lặng**: (a) B/S hứa "chiều/mai/tối gửi ảnh, báo lại…" → bot cảm ơn, không hỏi dồn, hệ thống đặt hẹn (`reminders`, giờ VN) và tới hẹn nhắc khéo MỘT tin không trách móc; người ta nhắn lại trước hẹn thì hủy nhắc; (b) buyer im lặng **5-6 ngày** → hỏi thăm 1-2 câu, **kịch bản đa dạng** (4 góc chọn ngẫu nhiên + tránh lặp 2 tin bot gần nhất), tối đa 1 lần/5 ngày/người — nhắc TRƯỚC mốc Zalo xoá kết nối 7 ngày (INS-03, thực thi FR-63 phía bot). Cron `nudge-tick` 30 phút | M | quyết định chủ dự án 25/08/2026; INS-03, FR-63 |
