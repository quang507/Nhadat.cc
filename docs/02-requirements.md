...
| FR-131 | **Gộp tin nhắn gõ vụn**: khách hay gõ 3–4 tin liên tiếp ("tìm nhà" / "quận 10" / "tầm 2 tỷ") — bot đợi **thích ứng**: tin ngắn cụt chưa có dấu kết câu (đang gõ tiếp) đợi ~2,5s gom chùm, tin đủ ý chỉ đợi ~0,4s để phản hồi gần như ngay *[cập nhật 25/08 theo phản hồi "1,5 giây vẫn lâu quá"]*; trong lúc đợi có tin mới hơn của cùng khách thì nhường lượt (không trả lời), chỉ lượt của tin cuối chùm trả lời trên toàn bộ ngữ cảnh gộp → MỘT câu trả lời duy nhất thay vì 3 câu chồng nhau. Kèm chống đua tạo trùng buyer/conversation khi tin đến đồng thời (advisory lock theo `zalo_user_id`) | M | quyết định chủ dự án 25/08/2026; bổ trợ FR-130 |
