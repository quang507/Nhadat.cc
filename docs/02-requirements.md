...
| FR-159 | ✅ **Phân vai bằng câu hỏi mở đầu, mặc định là người mua.** Người lạ không tự nhận có BĐS thì bot HỎI "muốn mua hay đang có bất động sản cần rao ạ?" (không gọi model); ai không nói rõ thì Ở LẠI hàng người mua vì đoán nhầm chiều đó rẻ hơn. Hồ sơ bán chỉ mở khi tự nhận có BĐS, và nhãn gán ngay lúc bóc tách: có nhà = chính chủ, chỉ ai tự xưng môi giới mới là NMG. Người đó được báo nhãn (một câu, KHÔNG kèm biểu phí — FR-176, 07/09/2026: phí nói khi họ hỏi và một câu lúc tin lên web); admin được báo nhãn + mức phí. | M | quyết định chủ dự án 27/08, 02/09 và 07/09/2026 |
