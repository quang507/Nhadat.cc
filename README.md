...
| 2 | [Requirements](docs/02-requirements.md) | 9 BR · 151 FR (4 deprecated) · 18 NFR · 5 giả định |
...
| 9 | [Open Issues](docs/09-open-issues.md) | 49 vấn đề — 14 đã chốt (OPEN-26, OPEN-27 chốt một phần), 2 đã giảm nhẹ 05/09 (OPEN-46/47), 33 còn chờ chủ dự án |
